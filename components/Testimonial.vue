        ...
        <div class="container">
            <div class="tns-outer" id="tns1-ow">
                <div class="tns-nav" aria-label="Carousel Pagination"><button type="button" data-nav="0"
                        ...
                        class="tns-nav-active"></button><button type="button" data-nav="1" aria-controls="tns1" style=""
                        aria-label="Carousel Page 2" class="" tabindex="-1"></button><button type="button" data-nav="2"
                        aria-controls="tns1" style="" aria-label="Carousel Page 3" class="" tabindex="-1"></button><button
                        ...
                        aria-controls="tns1" style="display:none" aria-label="Carousel Page 5"></button></div>
                <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span
                        class="current">5 to 6</span> of 5</div>
                <div id="tns1-mw" class="tns-ovh">
                    <div class="tns-inner" id="tns1-iw">
                        <div class="row testimonial-slider  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                            id="tns1" style="transform: translate3d(-36.3636%, 0px, 0px); transition-duration: 0s;">
                            <div class="col-lg-6 col-12 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
                            ...
                            <div class="col-lg-6 col-12 tns-item" id="tns1-item0" aria-hidden="true" tabindex="-1">
                            ...
                            <div class="col-lg-6 col-12 tns-item tns-slide-active" id="tns1-item1">
                            ...
                            <div class="col-lg-6 col-12 tns-item tns-slide-active" id="tns1-item2">
                            ...
                            <div class="col-lg-6 col-12 tns-item" id="tns1-item3" aria-hidden="true" tabindex="-1">
                            ...
                            <div class="col-lg-6 col-12 tns-item" id="tns1-item4" aria-hidden="true" tabindex="-1">
